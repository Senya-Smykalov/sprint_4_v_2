...
public static Collection<Object[]> data(){
    ...
    public void mood() {
        ...
        //Проверка, что кнопка "Заказать" снизу так же рабочая
        homePage.clickOrderBottom();
        //Возвращаемся на стартовую страницу
        homePage.buttonSamocat();
